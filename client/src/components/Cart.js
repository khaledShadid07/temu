    ...
    <>
      ...
      <main className='side-cart'>
        ...
        <div className='side-cart-pay-info'>
          <div className='side-cart-pay-info-p2 d-flex gap-1 mt-1'><div>د.أ</div> <div><del> 40.00</del> </div> </div>
        ...
        <div className='side-cart-pay-info-2'>
          <div style={{ color: 'rgb(251, 119, 1)' }} className='side-cart-pay-info-p2 d-flex gap-1 mt-1'><div>د.أ</div> <div><del> 40.00</del> </div> </div>
        ...
        <div className='side-cart-pay-info-2'>
          <article>
            <div className='side-cart-pay-info-p2 d-flex gap-1 mt-1'><div>د.أ</div> <div> 40.00 </div> </div>
            <p style={{backgroundColor:'rgb(10, 136, 0)',color:'white',padding:'2px',fontSize:'14px'}}>إجمالي التوفير ؜23.84 د.أ</p>

          </article>

          <div style={{ fontSize: '20px' }} className='side-cart-title-p'>: الاجمالي</div>
